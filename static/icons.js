(() => {
  ...
  const icons = {
    ...
    "upload-cloud": '<path d="M16 16l-4-4-4 4"/><path d="M12 12v9"/><path d="M20.4 18.2A5 5 0 0 0 18 9h-1.3A8 8 0 1 0 4 16.3"/>',
    ...
    bell: '<path d="M18 8a6 6 0 1 0-12 0c0 7-3 7-3 7h18s-3 0-3-7"/><path d="M13.7 21a2 2 0 0 1-3.4 0"/>',
    ...
    "file-spreadsheet": '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h8"/><path d="M8 17h8"/><path d="M8 9h2"/>',
    ...
    scale: '<path d="M12 3v18"/><path d="m7 8-4 8h8Z"/><path d="m21 16-4-8-4 8Z"/><path d="M5 21h14"/>',
    "square-pen": '<path d="M11 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5"/><path d="M17.5 3.5a2.1 2.1 0 0 1 3 3L12 15l-4 1 1-4Z"/>',
  ...
  window.lucide = {
    createIcons() {
      document.querySelectorAll("[data-lucide]").forEach((node) => {
        ...
        svg.innerHTML = `<svg ${attrs}>${icons[name] || icons.activity}</svg>`;
        node.replaceWith(svg.firstChild);
      });
    },
  };
})();
